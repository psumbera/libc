...
// O_DIRECT and SIGINFO are NOT available on Solaris. But in past they were
// defined here and thus other crates expected them. Latest version v0.29.0
// of Nix crate still expects this. Since last version of Nix crate is
// almost one year ago let's define these two temporarily before new Nix
// version is released.
pub const O_DIRECT: c_int = 0x2000000;
const SIGINFO: c_int = 41;
